...
class TourismList extends StatefulWidget {
  ...
  @override
  TourismListState createState() => TourismListState();
}

class TourismListState extends State<TourismList> {
  // --- variable ---
  String _category = "0";
  ...
  Future<String> showData(
    ...
    final result = await myHttp.get(SPLPDApiService.daftartWisata,
        SPLPDApiId.daftartWisataApiId, param);
  ...
  Future<String> hotelCategory() async {
    ...
    final result = await myHttp.get(
        SPLPDApiService.kategoriWisata, SPLPDApiId.kategoriWisataApiId);
