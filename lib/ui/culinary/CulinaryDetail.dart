...
class CulinaryDetail extends StatefulWidget {
  final String id;
  const CulinaryDetail({Key? key, required this.id}) : super(key: key);

  @override
  _CulinaryDetailState createState() => _CulinaryDetailState();
}

class _CulinaryDetailState extends State<CulinaryDetail> {
  // --- variable ---
  ...
  Future<String> showTourismDetail(String id) async {
    ...
    var response = await http.get(
      Uri.parse(ApiService.restaurantDetail + param),
  ...
  Future<String> showTourismReview(
    ...
    var response = await http.get(
      Uri.parse(ApiService.restaurantReviewList + param),
      headers: {"Accept": "application/json"},
    );
  ...
  Future<String> createTourismReview() async {
    ...
    map["restoran_id"] = this.widget.id.toString();
    map["user_id"] = prefs.getString(MyConstanta.userId);

    var response = await http.post(Uri.parse(ApiService.restaurantReviewCreate),
        headers: {
  ...
  Future<String> deleteTourismReview(String idTourismReview) async {
    ...
    var response = await http.post(Uri.parse(ApiService.restaurantReviewDelete),
        headers: {
          "Accept": "application/json",
          "Authorization": prefs.getString(MyConstanta.saveToken) ?? ''
        },
